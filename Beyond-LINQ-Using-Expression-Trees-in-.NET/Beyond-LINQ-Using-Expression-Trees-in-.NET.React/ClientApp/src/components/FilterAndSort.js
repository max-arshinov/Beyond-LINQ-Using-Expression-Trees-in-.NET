...
export class FilterAndSort extends Component {
  static displayName = FilterAndSort.name;
  ...
  render() {
    let contents = this.state.loading
      ? <p><em>Loading...</em></p>
      : FilterAndSort.renderDataTable(this.state.data);

    return (
      <div>
        <h1 id="tabelLabel" >Filter & OrderBy</h1>
