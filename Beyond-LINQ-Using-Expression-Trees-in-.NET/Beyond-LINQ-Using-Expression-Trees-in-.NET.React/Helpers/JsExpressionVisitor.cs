        ...
        public class JsExpressionVisitor : ExpressionVisitor
        {
            ...
            protected override Expression VisitLambda<T>(Expression<T> node)
            {
                ...
                else
                {
                    ...
                    Out('(');
                    string sep = ", ";
                    for (int i = 0, n = parameterCount; i < n; i++)
                    {
                        if (i > 0)
                        {
                            Out(sep);
            ...
            {
                var argumentCount = node.NewExpression.Arguments.Count;
                if (argumentCount == 0 &&
            ...
            {
                var argumentCount = initializer.Arguments.Count;
